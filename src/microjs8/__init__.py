"""MicroJS8 — JS8 transceiver application for Raspberry Pi.
...
See MicroJS8_Build_Specification.md §3 for the full architecture.
"""

from microjs8.version import __version__
