...
| Transceiver | QRP Labs QDX (primary), Xiegu G90 + DigiRig, Baofeng UV-5R + DigiRig, DL2MAN (tr)Usdx + DigiRig (PTT only no CAT)| Other Rigs via RTS-PTT via DigiRig, No CAT  |
