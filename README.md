# MiniJS8
<p align="center">
  <img src="images/screen1.jpg" alt="MiniJS8 device screen ó main view" width="280">
  <img src="images/screen2.jpg" alt="MiniJS8 device screen ó secondary view" width="280">
</p>
...
Raspberry Pi Zero 2W with a 240ó240 TFT SPI display, two GPIO buttons, and a
...
| Display | ST7789 240ó240 TFT SPI |
...
| Input | USB keyboard, 2ó GPIO buttons (backlight / shutdown gesture) |
...
The test suite is host-runnable ‚Äî no Pi hardware needed. The audio,
...
- **JS8Call** by Jordan Sherer KN4CRD ‚Äî the protocol and the original
